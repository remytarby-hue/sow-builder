          ...
          <div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:8}}>
              {sowHistory.slice(0, 10).map((entry, i) => (
                <div key={i} style={{background:C.card,border:"1px solid "+C.border,borderRadius:14,padding:"14px 16px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                  <div>
                  ...
                  <div style={{fontSize:11,color:C.muted,textAlign:"right",flexShrink:0,marginLeft:12}}>{entry.date ? formatDate(entry.date) : ""}</div>
                </div>
              ))}
            </div>
          </div>
