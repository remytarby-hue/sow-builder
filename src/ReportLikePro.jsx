...
const CATEGORIES = [
  ...
  },
  {
    ...
    phrases: [
      ...
      "Removed affected skirting boards.",
      "Drilled access holes in affected kickboards to inspect and facilitate drying.",
  ...
  },
  {
    ...
    phrases: [
      ...
      "Installed a dehumidifier to assist with drying where elevated moisture was present.",
  ...
  },
  {
    ...
    icon: null,
    phrases: [
      "Re-assessed moisture levels in affected areas.",
      "Checked the operation of mechanical drying equipment.",
      "Removed all mechanical drying equipment following dry moisture readings.",
      "Completed final walkthrough.",
      "Moisture levels had improved but remained elevated.",
      "Repositioned mechanical drying equipment to improve drying efficiency.",
      "Partially removed mechanical drying equipment where areas had reached dry standard.",
      "Repositioned remaining mechanical drying equipment to improve drying efficiency.",
      "Collected surface swab sample for testing.",
      "Surface swab results confirmed levels were within acceptable thresholds.",
    ]
  },
  {
    id: "fire_remediation",
  ...
  },
  {
    ...
    phrases: [
      ...
      "Installed zip doors where required to isolate affected rooms.",
      "Installed an Air Filtration Device with HEPA filtration to stabilise the environment.",
      "Removed and disposed of affected contaminated materials.",
      "HEPA vacuumed exposed surfaces within the affected area.",
      "Cleaned and sanitised affected surfaces using approved antimicrobial agents.",
      "Applied antimicrobial solution to affected surfaces.",
      "Installed mechanical drying equipment to assist with drying affected materials.",
      "Completed final walkthrough.",
      "Affected porous materials were removed due to contamination.",
      "Non-salvageable contaminated materials were removed and disposed of safely.",
      "Cleaning and sanitisation were completed to exposed surfaces following removal of contaminated materials.",
    ]
  },
  {
    id: "prv_cleaning",
  ...
  },
  {
    ...
    icon: null,
    phrases: [
      "Complete remediation of wall cavities following strip-out, including HEPA vacuuming, mould treatment, and structural drying as required.",
      "Pressure wash affected concrete flooring.",
      "Encapsulate affected timber or the back of plasterboard where required.",
      "Remove cabinetry to provide access to sanitise the flooring and assess the wall behind.",
      "Remove affected built-in cabinetry and wall linings from ceiling to floor to allow proper access for mould remediation and structural drying.",
      "Remove affected flooring to allow assessment and remediation of the subfloor.",
      "Remove affected wall linings to expose the wall cavity for further assessment, drying, and remediation.",
    ]
  },
  {
