...
const CAT_ICONS = {
  ...
  cat3_water_job: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>,
...
const CATEGORIES = [
  {
    ...
    icon: null,
    phrases: [
      "Undertook a walkthrough safety inspection and assessment of all affected areas",
      ...
      "Relocated contents from the affected area for the duration of works.",
      "Uplifted, removed, and disposed of affected carpet, underlay, and smooth edge.",
      "Uplifted, removed, and disposed of affected flooring.",
      "Removed and disposed of affected skirting boards.",
      "Drilled access holes into affected kick-boards to allow inspection and facilitate drying.",
      "HEPA vacuumed surfaces within the affected area.",
      "Applied antimicrobial solution to affected surfaces.",
      "Installed mechanical drying equipment.",
    ]
  },
  {
    ...
    phrases: [
      ...
      "Assessed areas for secondary damages",
  ...
  },
  {
    ...
    phrases: [
      ...
      "Liaised with the insured regarding the affected items.",
      "Commenced assessment of affected contents.",
      "Treated restorable items with antimicrobial solution to mitigate damage to the item and surrounding areas.",
      "Compiled an inventory of non-restorable contents.",
  ...
  },
  {
    ...
    phrases: [
      ...
      "Dry-cleaned affected surfaces using smoke sponges and approved fire cleaning chemicals.",
      "Wet-washed affected walls, ceilings, and surfaces following dry cleaning.",
      "Remediated affected contents using smoke sponges, HEPA vacuuming, and approved fire cleaning chemicals.",
      "Applied odour neutraliser to affected surfaces and contents to treat residual fire and smoke odour.",
      "Completed chemical fogging of affected areas, including ceiling cavities and ceiling joists where required.",
  ...
  },
  {
    ...
    phrases: [
      ...
      "Removal of affected porous materials is recommended",
  ...
  },
  {
    ...
    phrases: [
      ...
      "HEPA vacuumed exposed surfaces, including floors, walls, wall framing, and other accessible structural elements.",
